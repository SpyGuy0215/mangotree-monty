    ...
    return (<div id={'menu-container'} className={'fixed top-0 z-20 w-screen h-fit flex flex-col pointer-events-auto'}>
        <div id={'top-menu'} className={'w-full h-24 absolute z-20 flex flex-row backdrop-blur-md bg-zinc-900' +
            ...
            <div className={'h-full justify-center flex'}>
                <h1 className={'text-xl md:text-4xl mx-auto text-zinc-100 font-bold ml-2 md:ml-4 my-auto'}>The Mango Tree</h1>
            </div>
            <div id={'big-menu'}
                 className={'invisible w-0 h-0 absolute text-center md:relative md:visible md:w-fit ml-auto flex flex-row md:h-full text-xl justify-between px-8'}>
                ...
                <Link href={'/'} className={'h-fit w-fit my-auto px-3 absolute md:relative'}>
                ...
                <Link href={'https://www.clover.com/online-ordering/mango-tree-indian-cuisin-belle-mead'}
                      className={'h-fit w-fit my-auto px-3 absolute md:relative'}>
                ...
                <Link href={'https://www.clover.com/online-ordering/mango-tree-indian-cuisin-belle-mead'}
                      className={'h-fit w-fit my-auto px-3 absolute md:relative bg-orange-500 ml-1 hover:scale-110 transition ease-in-out'}>
