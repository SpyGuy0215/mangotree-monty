...
export default function Footer() {
    return (
        <div id={'footer'} className={'flex flex-col h-fit'}>
            <div className={'flex flex-col pt-4 md:pt-0 md:flex-row md:h-60 bg-black items-center'}>
                <div id={'box-1 contact-footer'} className={'flex flex-col text-white w-full md:w-5/12 text-center'}>
                    ...
                    <div id={'contact-footer-socials'} className={'flex flex-row w-fit self-center justify-between py-2'}>
                        ...
                        <Link href={'https://www.instagram.com/themangotreemonty?igsh=dHpiMHF3MXBwYnRz'}>
                            <Image src={'/instagram-icon.png'} alt={'Instagram Icon'} width={42} height={42}
                                   className={'aspect-square mr-2'}/>
                        </Link>
                    </div>
                </div>
                <div id={'box-2 image-footer'} className={'hidden md:flex w-full md:w-2/12 relative justify-center items-center'}>
            ...
            <div className={'w-full md:w-1/2 mx-auto flex flex-col items-center md:flex-row justify-around bg-black text-white py-4'}>
                <div className={'flex flex-row pb-2 md:pb-0'}>
                    <h3 className={'text-xl'}>Made by </h3>
                    <a href={'https://shashp.dev'}>
                        <h3 className={'text-blue-500 hover:text-blue-400 transition duration-300 ml-2 text-xl'}>Shashank Prasanna</h3>
                    </a>
                </div>
                <h3 className={'text-xl'}>© 2025 The Mango Tree</h3>
            </div>
        </div>
    )
}